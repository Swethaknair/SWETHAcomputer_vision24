import cv2
import numpy as np
image = cv2.imread(r'C:\Users\HP\Downloads\WhatsApp Image 2023-10-16 at 8.26.58 AM.jpeg')
img2 = cv2.imread(r'C:\Users\HP\Pictures\Screenshots\Screenshot 2023-10-17 091018.png')
print(image.shape)
